<template>
  <nav class="nav container">
    <ul class="nav__list">
      ...
      <li class="nav__item">
        <router-link to="/delivery&payment" class="nav__link">
          Каталог товаров
          <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 86 860 860" width="20">
    ...
    <ul class="nav__oprions">
      <li class="nav__item">
        <router-link to="/" class="nav__auth">
